...
import type { CallHistoryEntry, CallType, CallStatus } from '@/types';

const LUNA: { id: string; name: string } = { id: 'luna', name: 'Luna AI' };
    ...
    <DashboardLayout>
      <div className="space-y-6 pb-8">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-white/45">Connect with Luna through audio or video</p>
        </div>
